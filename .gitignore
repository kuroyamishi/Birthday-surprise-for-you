  ...
  <body>
    ...
    <div id="card">
      <div id="card-inside">
       <div class="wrap">
  <center>
    <p class="animated infinite wobble"><b><u>Happy Birthday My Love ♡</b></u></p>
    <center>
      <p>
        Ei yamnadi haining ngai leite fir bhi he bohot bolne ko
I just wanted to wish you a sweet and cherishing birthday. And since I wanted to make it a little special, I did what I learned recently hehehe😁 ;<i class="em-svg em-blush"></i>
      </p>
      <p>
        Happy Birthday Nungcbi,

 Ngasi se ng nanak lakpa yadra banina eisu 
   nung ngaite but ye saab apke liye he

              I love you ♡

Ngna si numit sida poklakpei thank you kyuki 
     tum mere hone wale the isliye 
           iss din ko peda 
                 hui😁

  and ei ng mayaaaaaaaaaaaaaaaaaaaaaammmmm 
              nungciiiiiii

Konna ei lakpa dane eigi da oina fajnna koira 
                naba ko
      ...
      <p class="signed">
        <u>Made With Love <i class="em-svg em-heart"></i></b><b> By your Nungcba👀</u>
      </p>
</div>
      ...
      <div id="card-front">
        <div class="wrap">
          <h1 class="animated infinite swing">Happiest Birthday My Love ♡</h1>
        ...
        <div class="card-front_inside">
          <br> <br> <br>
          <div class="polaroid">
            <div class="img" style="background-image: url('https://photos.app.goo.gl/pRTvfG5cHLa1i7KYA-unsplash.jpg')"></div>
          </div>
          <div
            data-balloon="I wanted to put your picture here but... ngmdre twrasu yadre😭"
